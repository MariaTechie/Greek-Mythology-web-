"use strict";(self.__LOADABLE_LOADED_CHUNKS__=self.__LOADABLE_LOADED_CHUNKS__||[]).push([[168],{720687:(e,t,n)=>{n.d(t,{default:()=>r});var a=n(934980);let i=`pulsing {
  ...
  .masonryContainer {
    ...
    ${y}
  `}}({gutterWidth:q,flexible:K,items:y,isRTL:N,itemWidth:J,maxColumns:e.maxColumns??Math.max(y.length,v.g5),minColumns:Q,_getColumnSpanConfig:W}),ed=`${eu} ${em}`.trim(),{anyEnabled:ec,expName:eh,group:ey,isMeasureAllEnabled:ef}=(0,d.Z)(),ex=(0,a.useMemo)(()=>!en||y.every(e=>!en.has(e)),[]),eb=ey&&ex,eg=(0,a.useRef)(),e_=(0,a.useRef)(y.length),ew=(0,a.useRef)(0);(0,a.useEffect)(()=>{eb&&y.forEach((e,t)=>{O.current[t]||(O.current[t]={fetchTimestamp:Date.now(),measureTimestamp:0,hasRendered:!1,pageCount:ew.current})}),e_.current=y.length,ew.current+=1},[y]),(0,a.useEffect)(()=>{ei.current&&(ei.current=!1)},[]),(0,a.useEffect)(()=>{let e=()=>ee.current+=1;return eb&&(eg.current=Date.now(),window.addEventListener("scroll",e)),()=>{if(eb){let t=O.current;window.removeEventListener("scroll",e);let n=t.filter(e=>!!e.measureTimestamp).length,a=t.filter(e=>e.hasRendered).length,i=e_.current,r={deviceType:A,experimentName:eh,experimentGroup:ey,handlerId:T,isAuthenticated:B};(0,$.LY)("webapp.masonry.timeSpent",eg.current?Date.now()-eg.current:0,{tags:r}),(0,$.S0)("webapp.masonry.itemsFetched",i,{tags:r}),(0,$.S0)("webapp.masonry.itemsMeasured",n,{tags:r}),(0,$.S0)("webapp.masonry.itemsMeasuredPercentage",Math.floor(n/i*100),{tags:r}),(0,$.S0)("webapp.masonry.itemsRendered",a,{tags:r}),(0,$.S0)("webapp.masonry.itemsRenderedPercentage",Math.floor(a/i*100),{tags:r}),(0,$.S0)("webapp.masonry.scrollCount",ee.current,{tags:r})}}},[]);let ev=(0,a.useCallback)((e,t,n)=>{let a=e.reduce((e,t)=>e+t),i=a/e.length;(0,$.S0)("webapp.masonry.multiColumnWhitespace.average",i,{sampleRate:1,tags:{earlyBailoutExperimentGroup:eo||"unknown",experimentalMasonryGroup:ey||"unknown",fluidGridGroup:X||"unknown",handlerId:T,isAuthenticated:B,multiColumnItemSpan:e.length}}),(0,$.S0)("webapp.masonry.twoColWhitespace",i,{sampleRate:1,tags:{columnWidth:J,minCols:Q}}),eo&&(0,$.S0)("webapp.masonry.graphIterations",t,{sampleRate:1,tags:{columnSpan:n,exprimentGroup:eo}}),Z({event_type:15878,component:14468,aux_data:{total_whitespace_px:a}}),Z({event_type:16062,component:14468,aux_data:{average_whitespace_px:i}}),Z({event_type:16063,component:14468,aux_data:{max_whitespace_px:Math.max(...e)}}),e.forEach(t=>{t>=50&&((0,$.nP)("webapp.masonry.multiColumnWhitespace.over50",{sampleRate:1,tags:{earlyBailoutExperimentGroup:eo||"unknown",experimentalMasonryGroup:ey||"unknown",fluidGridGroup:X||"unknown",handlerId:T,isAuthenticated:B,multiColumnItemSpan:e.length}}),Z({event_type:16261,component:14468})),t>=100&&((0,$.nP)("webapp.masonry.multiColumnWhitespace.over100",{sampleRate:1,tags:{earlyBailoutExperimentGroup:eo||"unknown",experimentalMasonryGroup:ey||"unknown",fluidGridGroup:X||"unknown",handlerId:T,isAuthenticated:B,multiColumnItemSpan:e.length}}),Z({event_type:16262,component:14468}))}),(0,$.nP)("webapp.masonry.multiColumnWhitespace.count",{sampleRate:1,tags:{earlyBailoutExperimentGroup:eo||"unknown",experimentalMasonryGroup:ey||"unknown",fluidGridGroup:X||"unknown",handlerId:T,isAuthenticated:B,multiColumnItemSpan:e.length}})},[J,eo,Z,Q,B,T,X,ey]),{_items:eM,_renderItem:eC}=function({initialLoadingStatePinCount:e=50,infiniteScrollPinCount:t=10,isFetching:n,items:i=[],renderItem:r,useLoadingState:o}){let{isInGridInfiniteScrollExp:s}=(0,c.Z)(),l=o&&n&&0===i.length,u=o&&n&&s&&i.length>0,m=(0,a.useMemo)(()=>Array.from({length:u?t:e}).reduce((e,t,n)=>[...e,{height:n%2==0?356:236,key:`skeleton-pin-${n}`,isSkeleton:!0}],[]),[e,t,u]);return{_items:(0,a.useMemo)(()=>l?m:u?[...i,...m]:i,[l,u,i,m]),_renderItem:(0,a.useMemo)(()=>o?e=>{let{itemIdx:t,data:n}=e;return t>=i.length&&n&&"object"==typeof n&&"key"in n&&"height"in n?/*#__PURE__*/(0,x.jsx)(w,{data:n},n.key):r(e)}:r,[o,r,i.length])}}({useLoadingState:L,items:y,renderItem:(0,a.useCallback)(e=>eb?/*#__PURE__*/(0,x.jsx)(E,{analyticsData:O,idx:e.itemIdx,isMeasuring:e.isMeasuring,masonryV2ExpGroup:ey,masonryV2ExpName:eh,children:/*#__PURE__*/(0,x.jsx)(o.Z,{name:"MasonryItem",children:G(e)})}):/*#__PURE__*/(0,x.jsx)(o.Z,{name:"MasonryItem",children:G(e)}),[G]),isFetching:u});return/*#__PURE__*/(0,x.jsx)("div",{className:"masonryContainer","data-test-id":"masonry-container",id:s,style:z?{padding:`0 ${q/2}px`}:void 0,children:/*#__PURE__*/(0,x.jsxs)("div",{className:ed,children:[Y&&ei.current?/*#__PURE__*/(0,x.jsx)(f.Z,{"data-test-id":"masonry-ssr-styles",unsafeCSS:ep}):null,/*#__PURE__*/(0,x.jsx)(i.xu,{"data-test-id":"max-width-container",marginBottom:0,marginEnd:"auto",marginStart:"auto",marginTop:0,maxWidth:e.maxColumns?et*e.maxColumns:void 0,children:ec?/*#__PURE__*/(0,x.jsx)(i.GX,{ref:e=>{_&&(_.current=e)},_dynamicHeights:D,_dynamicHeightsV2Experiment:el,_earlyBailout:es,_getColumnSpanConfig:W,_logTwoColWhitespace:ev,_measureAll:ef,align:t,columnWidth:J,gutterWidth:q,items:eM,layout:K?U:b??"basic",loadItems:g,measurementStore:en,minCols:Q,renderItem:eC,scrollContainer:ea,virtualBufferFactor:.3,virtualize:I}):/*#__PURE__*/(0,x.jsx)(i.Rk,{ref:e=>{_&&(_.current=e)},_dynamicHeights:D,_dynamicHeightsV2Experiment:el,_earlyBailout:es,_getColumnSpanConfig:W,_logTwoColWhitespace:ev,align:t,columnWidth:J,gutterWidth:q,items:eM,layout:K?U:b??"basic",loadItems:g,measurementStore:en,minCols:Q,renderItem:eC,scrollContainer:ea,virtualBufferFactor:.3,virtualize:I})})]})})}},39260:(e,t,n)=>{n.d(t,{Z:()=>o});var a=n(297728),i=n(730212),r=n(855746);function o(e){let{isAuthenticated:t}=(0,i.B)(),{expName:n,anyEnabled:o,group:s}=function({experimentsClient:e,handlerId:t,isAuthenticated:n,skipActivation:a}){let{checkExperiment:i}=e,r=i(n?"web_masonry_v2_auth":"web_masonry_v2_unauth",{dangerouslySkipActivation:a});return r.group?{expName:n?"web_masonry_v2_auth":"web_masonry_v2_unauth",...r}:"www/[username]/[slug].js"!==t||n?"www/pin/[id].js"!==t||n?{expName:"",anyEnabled:!1,group:""}:{expName:"web_masonry_v2_unauth_pin",...i("web_masonry_v2_unauth_pin",{dangerouslySkipActivation:a})}:{expName:"web_masonry_v2_unauth_board",...i("web_masonry_v2_unauth_board",{dangerouslySkipActivation:a})}}({experimentsClient:(0,a.F)(),handlerId:(0,r.MM)(),isAuthenticated:t,skipActivation:e?.skipActivation??!1});return{expName:n,anyEnabled:o,group:s,isMeasureAllEnabled:"enabled_measure_all"===s||"enabled_measure_all_impression_fix"===s,isImpressionFixEnabled:"control_impression_fix"===s||"enabled_impression_fix"===s||"enabled_measure_all_impression_fix"===s}}},2968:(e,t,n)=>{n.d(t,{Z:()=>a});let a=e=>e.startsWith("enabled")||e.startsWith("employee")}}]);
//# sourceMappingURL=https://sm.pinimg.com/webapp/168-df7275051e6f802b.mjs.map